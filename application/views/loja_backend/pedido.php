    ...
    <div class="panel panel-default">
        <div class='panel-heading'>
            ...
            foreach ($detalhes as $detalhe) {
                ...
                "<b> Data do pedido: </b>" . dataMySQL_to_dataBr($detalhe->data_adicionado) . br() .
        ...
        <div class='panel-body'>
            ...
            foreach ($itens as $item) {
                ...
                if (is_file("assets/uploads/images/produtos/" . md5($item->id) . ".jpg")) {
                    $image_properties = array(
                        'src' => "assets/uploads/images/produtos/" . md5($item->id) . ".jpg",
                        'alt' => 'Categoria NetCriativa sem Imagem',
                        'class' => 'cat_images',
                        'width' => '100px',
                        'height' => '',
                ...
                $this->table->add_row($imagem, $item->item, $item->titulo, $item->quantidade, reais($item->preco), reais($item->preco * $item->quantidade));
            }
